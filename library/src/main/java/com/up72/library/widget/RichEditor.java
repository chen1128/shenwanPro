...
public class RichEditor extends WebView {
  ...
  public void loadNoteTemplate(String html) {
       loadUrl(SETUP_HTML+html);
  }
  ...
  public void insertImage(String url, String alt,String width) {
    exec("javascript:RE.prepareInsert();");
  ...
  protected class EditorWebViewClient extends WebViewClient {
    ...
    @Override public boolean shouldOverrideUrlLoading(WebView view, String url) {
      ...
      if(url.endsWith(".mp3")){
        ...
        UPlayer uPlayer = new UPlayer(url);
        uPlayer.start();
        return true;
      }else if (url.endsWith(".png") || url.endsWith(".jpg") || url.endsWith(".JPG")){
